...
Script to create an IV-Curve for two cells, according to the parameters
provided by ASCA.

Switches between two cells using the 7001 Switch System. The order of 
measurements is to complete one IV-Curve then another.
"""
