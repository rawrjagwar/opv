...
# switch system is reset and opens all channels then selects requested channels
switchsystem.write(':open all')
switchsystem.write(':clos:stat?')
print(switchsystem.read())
time.sleep(2)
switchsystem.write(':clos (@1!2, 1!4, 1!12, 1!24)')
switchsystem.write(':clos:stat?')
print(switchsystem.read())
time.sleep(1)
